...
mkPage('home',true,`<div class="ph" style="min-height:38vh;display:flex;flex-direction:column;justify-content:flex-end">
  ...
  <p>Inmigración y transformación demográfica en la ciudad de Nueva York, demostrado matemáticamente mediante el <strong>Índice de Estabilidad Urbana</strong>.</p>
</div>
<div class="pc">
  <div class="stat-row">
  ...
  <div class="g2" style="margin-bottom:24px">
    ...
    <div>
      ...
      <div class="meter-wrap">
        <div class="meter-title">Umbral de equilibrio — Política actual</div>
        ...
        <div class="meter-status" id="hMStatus" style="background:rgba(245,166,35,.07);color:var(--orange)">66.000 llegadas/año — 9.388 sobre el umbral.</div>
      </div>
    </div>
  </div>
  <div class="g3">
...
<div class="pc">
  ...
  <div class="meter-wrap">
    ...
    <div class="meter-status" id="mStatus" style="background:rgba(245,166,35,.07);color:var(--orange)">Política actual: 66.000/año, 9.388 por encima del umbral. Marginal.</div>
  </div>
