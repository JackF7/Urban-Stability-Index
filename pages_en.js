  ...
  <div class="ctrl-grid">
    <div class="ctrl-section">
      ...
      <div class="meter-wrap" style="margin-top:6px;margin-bottom:10px">
        ...
        <div class="meter-labels" style="margin-top:10px"><span>−150k outflow/yr</span><span>0 (no outflow)</span></div>
      </div>
      <div class="meter-status" id="domStatus" style="background:rgba(212,112,106,.08);color:var(--red);border-left:3px solid var(--red)">Current: −91,239 domestic residents leave/yr</div>
